...
<div class="footer-section">
    ...
    <p>
        <a href="politique-confidentialite.php"><?php echo htmlspecialchars(t('footer.privacy'), ENT_QUOTES, 'UTF-8'); ?></a>
    </p>
    <p><a href="politique-cookies.php"><?php echo htmlspecialchars(t('footer.cookies'), ENT_QUOTES, 'UTF-8'); ?></a></p>
    <p><a href="#"
          data-cookie-preferences><?php echo htmlspecialchars(t('footer.cookie_prefs'), ENT_QUOTES, 'UTF-8'); ?></a></p>
</div>